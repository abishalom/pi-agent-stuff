...
Do not modify files or apply fixes. Do not delegate or attempt to spawn subagents; nested delegation is unavailable. Use only the tools provided in this session. The session remains open for direct questions and follow-up reviews.
